...
const bach: string = `
The Project Gutenberg eBook of Johann Sebastian Bach: His Life, Art, and Work
...
*** START OF THE PROJECT GUTENBERG EBOOK JOHANN SEBASTIAN BACH: HIS LIFE, ART, AND WORK ***
...
*** END OF THE PROJECT GUTENBERG EBOOK JOHANN SEBASTIAN BACH: HIS LIFE, ART, AND WORK ***
...
const astronomy: string = `
The Project Gutenberg eBook of History of Astronomy
...
LAPLACE, ETC.
 9. DISCOVERY OF NEW PLANETS—HERSCHEL, PIAZZI, ADAMS,
AND LE VERRIER
...
_Chaldæans_.—Until the last half century historians were accustomed to
look back upon the Greeks, who led the world from the fifth to the
third century B.C., as the pioneers of art, literature, and science.
But the excavations and researches of later years make us more ready to
grant that in science as in art the Greeks only developed what they
derived from the Egyptians, Babylonians, and Assyrians. The Greek
historians said as much, in fact; and modern commentators used to
attribute the assertion to undue modesty. Since, however, the records
of the libraries have been unearthed it has been recognised that the
Babylonians were in no way inferior in the matter of original
scientific investigation to other races of the same era.

The Chaldæans, being the most ancient Babylonians, held the same
station and dignity in the State as did the priests in Egypt, and spent
all their time in the study of philosophy and astronomy, and the arts
of divination and astrology. They held that the world of which we have
a conception is an eternal world without any beginning or ending, in
...
Nabushum-iddin, Great Astronomer of Nineveh, writes thus: “May Nabu and
Marduk be propitious to the Director of these Observations, my Lord.
The fifteenth day we observed the Node of the moon, and the moon was
eclipsed.”
...
writings of Diodorus Siculus. But confirmatory and more authentic facts
have been derived from late explorations. Thus we learn from E. B.
Knobel[2] about the Jewish calendar dates, on records of land sales in
Aramaic papyri at Assuan, translated by Professor A. H. Sayce and A. E.
...
from the fourth century A.D.], a date a “little more than a century
after the grandfathers and great-grandfathers of those whose business
is recorded had fled into Egypt with Jeremiah” (Sayce); and (2) that
the order of intercalation at that time was not dissimilar to that in
...
the date May 28th, 585 B.C. But other modern astronomers give different
dates. Thales went to Egypt to study science, and learnt from its
priests the length of the year (which was kept a profound secret!), and
the signs of the zodiac, and the positions of the solstices. He held
...
earth cuts off the sun’s light from her. He supposed the earth to be
flat, and to float upon water. He determined the ratio of the sun’s
diameter to its orbit, and apparently made out the diameter correctly
...
Anaxagoras (born 499 B.C.) studied astronomy in Egypt. He explained the
return of the sun to the east each morning by its going under the flat
earth in the night. He held that in a solar eclipse the moon hides the
sun, and in a lunar eclipse the moon enters the earth’s shadow—both
...
Solon dabbled, like many others, in reforms of the calendar. The common
year of the Greeks originally had 360 days—twelve months of thirty
days. Solon’s year was 354 days. It is obvious that these erroneous
years would, before long, remove the summer to January and the winter
to July. To prevent this it was customary at regular intervals to
intercalate days or months. Meton (432 B.C.) introduced a reform based
on the nineteen-year cycle. This is not the same as the Egyptian and
Chaldean eclipse cycle called _Saros_ of 223 lunations, or a little
...
relative to the stars. It is still used for fixing the date of Easter,
the number of the year in Melon’s cycle being the golden number of our
...
He made astronomical observations in Asia Minor, Sicily, and Italy, and
described the starry heavens divided into constellations. His name is
connected with a planetary theory which as generally stated sounds most
fanciful. He imagined the fixed stars to be on a vault of heaven; and
the sun, moon, and planets to be upon similar vaults or spheres,
...
thirty-three. It is now generally accepted that the real existence of
...
in his time, and held the earth to be fixed in the centre of the world.
...
myth of Atlas, or the Indians with the tortoise. Thales thought that
the flat earth floated on water. Anaxagoras thought that, being flat,
it would be buoyed up and supported on the air like a kite. Democritus
thought it remained fixed, like the donkey between two bundles of hay,
because it was equidistant from all parts of the containing sphere, and
there was no reason why it should incline one way rather than another.
Empedocles attributed its state of rest to centrifugal force by the
rapid circular movement of the heavens, as water is stationary in a
pail when whirled round by a string. Democritus further supposed that
the inclination of the flat earth to the ecliptic was due to the
greater weight of the southern parts owing to the exuberant vegetation.
...
very complete, but some of his conclusions are doubtful. At p. 113 of
that work he records the real opinions of Socrates as set forth by
Xenophon; and the reader will, perhaps, sympathise with Socrates in his
views on contemporary astronomy:—
...
all astronomical investigation from this date till the time of Kepler
in the sixteenth century. He proposed to astronomers _the problem of
...
equator of the sun’s apparent path in the heavens—i.e., he measured the
obliquity of the ecliptic, making it 23° 51’, confirming our knowledge
of its continuous diminution during historical times. He measured an
arc of meridian, from Alexandria to Syene (Assuan), and found the
difference of latitude by the length of a shadow at noon, summer
...
motion of the sun; and allowed for this in his calculations by
supposing that the centre, about which the sun moves uniformly, is
situated a little distance from the fixed earth. He called this point
the _excentric_. The line from the earth to the “excentric” was called
the _line of apses_. A circle having this centre was called the
_equant_, and he supposed that a radius drawn to the sun from the
excentric passes over equal arcs on the equant in equal times. He then
...
by the Newtonian theory for quite a long time.] He determined the plane
of the moon’s orbit and its inclination to the ecliptic. The motion of
this plane round the pole of the ecliptic once in eighteen years
complicated the problem. He located the moon’s excentric as he had done
the sun’s. He also discovered some of the minor irregularities of the
moon’s motion, due, as Newton’s theory proves, to the disturbing action
...
from the poles of the earth—i.e., the equinox. He found that this could
be explained by a motion of the equinox in the direction of the
...
necessary for the progress of accurate astronomical observations. It is
due to a steady revolution of the earth’s pole round the pole of the
ecliptic once in 26,000 years in the opposite direction to the
...
modern astronomers have often attempted to fix dates in history by the
effects of precession of the equinoxes. (1) At about the date when the
Great Pyramid may have been built γ Draconis was near to the pole, and
must have been used as the pole-star. In the north face of the Great
Pyramid is the entrance to an inclined passage, and six of the nine
pyramids at Gizeh possess the same feature; all the passages being
inclined at an angle between 26° and 27° to the horizon and in the
plane of the meridian. It also appears that 4,000 years ago—i.e., about
2100 B.C.—an observer at the lower end of the passage would be able to
see γ Draconis, the then pole-star, at its lower culmination.[1] It has
been suggested that the passage was made for this purpose. On other
grounds the date assigned to the Great Pyramid is 2123 B.C.

(2) The Chaldæans gave names to constellations now invisible from
Babylon which would have been visible in 2000 B.C., at which date it is
claimed that these people were studying astronomy.
...
Homer, both in the _Odyssey_[2] (v. 272-5) and in the _Iliad_ (xviii.
489), asserts that the Great Bear never set in those latitudes. Now it
has been found that the precession of the equinoxes explains all these
puzzles; shows that in springtime on the Mediterranean the Bear was
just above the horizon, near the sea but not touching it, between 750
B.C. and 1000 B.C.; and fixes the date of the poems, thus confirming
other evidence, and establishing Homer’s character for accuracy.[3]
...
the heliacal risings[4] of certain stars. If the star were known, this
...
the sun and moon. He adopted the epicycles and deferents which had been
used by Apollonius and others to explain the retrograde motions of the
planets. We, who know that the earth revolves round the sun once in a
year, can understand that the apparent motion of a planet is only its
motion relative to the earth. If, then, we suppose the earth fixed and
the sun to revolve round it once a year, and the planets each in its
own period, it is only necessary to impose upon each of these an
additional _annual_ motion to enable us to represent truly the apparent
motions. This way of looking at the apparent motions shows why each
planet, when nearest to the earth, seems to move for a time in a
retrograde direction. The attempts of Ptolemy and others of his time to
explain the retrograde motion in this way were only approximate. Let us
suppose each planet to have a bar with one end centred at the earth. If
at the other end of the bar one end of a shorter bar is pivotted,
having the planet at its other end, then the planet is given an annual
motion in the secondary circle (the epicycle), whose centre revolves
round the earth on the primary circle (the _deferent_), at a uniform
rate round the excentric. Ptolemy supposed the centres of the epicycles
of Mercury and Venus to be on a bar passing through the sun, and to be
between the earth and the sun. The centres of the epicycles of Mars,
Jupiter, and Saturn were supposed to be further away than the sun.
Mercury and Venus were supposed to revolve in their epicycles in their
own periodic times and in the deferent round the earth in a year. The
major planets were supposed to revolve in the deferent round the earth
in their own periodic times, and in their epicycles once in a year.
...
Egyptians (we are told by Cicero and others), and was accepted by Tycho
Brahe; and was as true a representation of the relative motions in the
solar system as when we suppose the sun to be fixed and the earth to
revolve.

The cumbrous system advocated by Ptolemy answered its purpose, enabling
him to predict astronomical events approximately. He improved the lunar
theory considerably, and discovered minor inequalities which could be
allowed for by the addition of new epicycles. We may look upon these
epicycles of Apollonius, and the excentric of Hipparchus, as the
responses of these astronomers to the demand of Plato for uniform
circular motions. Their use became more and more confirmed, until the
seventeenth century, when the accurate observations of Tycho Brahe
enabled Kepler to abolish these purely geometrical makeshifts, and to
...
likewise call the Wain, which turneth ever in one place, and keepeth
...
After Ptolemy had published his book there seemed to be nothing more to
do for the solar system except to go on observing and finding more and
more accurate values for the constants involved--viz., the periods of
revolution, the diameter of the deferent,[1] and its ratio to that of
the epicycle,[2] the distance of the excentric[3] from the centre of
the deferent, and the position of the line of apses,[4] besides the
inclination and position of the plane of the planet’s orbit. The only
object ever aimed at in those days was to prepare tables for predicting
the places of the planets. It was not a mechanical problem; there was
...
and others, according to which the sun is fixed and the earth revolves;
and it must be noted that, geometrically, there is no difference of any
sort between the Egyptian or Tychonic system and that of Pythagoras as
revived by Copernicus, except that on the latter theory the stars ought
to seem to move when the earth changes its position—a test which failed
completely with the rough means of observation then available. The
radical defect of all solar systems previous to the time of Kepler
(1609 A.D.) was the slavish yielding to Plato’s dictum demanding
uniform circular motion for the planets, and the consequent evolution
of the epicycle, which was fatal to any conception of a dynamical
theory.

Copernicus could not sever himself from this obnoxious tradition.[5] It
is true that neither the Pythagorean nor the Egypto-Tychonic system
...
Hipparchus to explain the irregular motion known as the equation of the
centre. But Copernicus remarked that he could also use an epicycle for
this purpose, or that he could use both an excentric and an epicycle
for each planet, and so bring theory still closer into accord with
observation. And this he proceeded to do.[6] Moreover, observers had
found irregularities in the moon’s motion, due, as we now know, to the
disturbing attraction of the sun. To correct for these irregularities
...
relates to the seasons, and it shows a strange ignorance of the laws of
rotating bodies. To use the words of Delambre,[7] in drawing attention
to the strange conception,
 ...
 explain them he invented a third motion, and added it to the two real
 motions (rotation and orbital revolution). By this third motion the
 earth, he held, made a revolution on itself and on the poles of the
 ecliptic once a year ... Copernicus did not know that motion in a
 straight line is the natural motion, and that motion in a curve is the
 resultant of several movements. He believed, with Aristotle, that
...
perhaps undue space to the interesting work of Copernicus, because by a
curious chance his name has become so widely known. He has been spoken
of very generally as the founder of the solar system that is now
accepted. This seems unfair, and on reading over what has been written
about him at different times it will be noticed that the
...
that the earth was fixed. So he sought and obtained the support of the
Church, dedicating his great work to Pope Paul III. in a lengthy
...
representative, of the Epicyclical School. As has been already stated,
his successor, Tycho Brahe, supported the same use of epicycles and
excentrics as Copernicus, though he held the earth to be fixed. But
Tycho Brahe was eminently a practical observer, and took little part in
theory; and his observations formed so essential a portion of the
system of Kepler that it is only fair to include his name among these
who laid the foundations of the solar system which we accept to-day.
...
_Six Lectures on Astronomy_, the impression is made that the jointed
bars there spoken of for describing the circles were supposed to be
real. This is no more the case than that the spheres of Eudoxus and
Callippus were supposed to be real. Both were introduced only to
illustrate the mathematical conception upon which the solar, planetary,
and lunar tables were constructed. The epicycles represented nothing
more nor less than the first terms in the Fourier series, which in the
last century has become a basis of such calculations, both in astronomy
and physics generally.

[Illustration: “QUADRANS MURALIS SIVE TICHONICUS.”
With portrait of Tycho Brahe, instruments, etc., painted on the wall;
showing assistants using the sight, watching the clock, and recording.
(From the author’s copy of the _Astronomiæ Instauratæ Mechanica_.)]
...
FOOTNOTES:
 ...
 sphere is, of all figures, the most perfect” (Delambre, _Ast. Mod.
 Hist_., pp. 86, 87).

 [6] Kepler tells us that Tycho Brahe was pleased with this device, and
 ...
 Neque enim necesse est, eas hypotheses esse veras, imo ne verisimiles
 quidem, sed sufficit hoc usum, si calculum observationibus congruentem
 exhibeant.”
...
fostered by the invention of printing, by the downfall of the Byzantine
Empire, and the scattering of Greek fugitives, carrying the treasures
of literature through Western Europe, by the works of Raphael and
Michael Angelo, by the Reformation, and by the extension of the known
world through the voyages of Spaniards and Portuguese. During that
period there came to the front the founder of accurate observational
astronomy. Tycho Brahe, a Dane, born in 1546 of noble parents, was the
most distinguished, diligent, and accurate observer of the heavens
...
accurate observations. We may claim for him the title of founder of the
inductive method.
...
country. He granted to him the island of Hveen, gave him a pension, and
made him a canon of the Cathedral of Roskilde. On that island Tycho
Brahe built the splendid observatory which he called Uraniborg, and,
later, a second one for his assistants and students, called
...
rigidity in the instruments, and, whereas these had generally been made
of wood, he designed them in metal. His instruments included armillae
like those which had been used in Alexandria, and other armillae
designed by himself—sextants, mural quadrants, large celestial globes
and various instruments for special purposes. He lived before the days
of telescopes and accurate clocks. He invented the method of
sub-dividing the degrees on the arc of an instrument by transversals
...
of obtaining a better accordance between theory and observation; and he
was not too ambitious, as his desire was to get the tables accurate to
ten minutes. Tycho Brahe found that the tables of Copernicus were in
error as much as two degrees. He re-discovered the inequality called
“variation” by observing the moon in all phases—a thing which had not
been attended to. [It is remarkable that in the nineteenth century Sir
George Airy established an altazimuth at Greenwich Observatory with
this special object, to get observations of the moon in all phases.] He
also discovered other lunar equalities, and wanted to add another
epicycle to the moon’s orbit, but he feared that these would soon
become unmanageable if further observations showed more new
inequalities.

But, as it turned out, the most fruitful work of Tycho Brahe was on the
motions of the planets, and especially of the planet Mars, for it was
by an examination of these results that Kepler was led to the discovery
of his immortal laws.

After the death of King Frederick the observatories of Tycho Brahe were
not supported. The gigantic power and industry displayed by this
...
Emperor Rudolph II., who placed a house in Prague at his disposal. Here
he worked for a few years, with Kepler as one of his assistants, and he
...
It has already been stated that Tycho Brahe maintained that observation
must precede theory. He did not accept the Copernican theory that the
earth moves, but for a working hypothesis he used a modification of an
old Egyptian theory, mathematically identical with that of Copernicus,
but not involving a stellar parallax. He says (_De Mundi_, _etc_.) that
...
mathematical principles, was in opposition to those of physics, as the
heavy and sluggish earth is unfit to move, and the system is even
opposed to the authority of Scripture. The absence of annual parallax
further involves an incredible distance between the outermost planet
and the fixed stars.

We are bound to admit that in the circumstances of the case, so long as
there was no question of dynamical forces connecting the members of the
solar system, his reasoning, as we should expect from such a man, is
practical and sound. It is not surprising, then, that astronomers
...
at Wiel, in the Duchy of Wurtemberg, in 1571. He held an appointment at
Gratz, in Styria, and went to join Tycho Brahe in Prague, and to assist
in reducing his observations. These came into his possession when Tycho
Brahe died, the Emperor Rudolph entrusting to him the preparation of
new tables (called the Rudolphine tables) founded on the new and
accurate observations. He had the most profound respect for the
knowledge, skill, determination, and perseverance of the man who had
reaped such a harvest of most accurate data; and though Tycho hardly
recognised the transcendent genius of the man who was working as his
assistant, and although there were disagreements between them, Kepler
held to his post, sustained by the conviction that, with these
observations to test any theory, he would be in a position to settle
for ever the problem of the solar system.

[Illustration: PORTRAIT OF JOHANNES KEPLER. By F.
Wanderer, from Reitlinger’s “Johannes Kepler” (original in
Strassburg).]
...
with these _à priori_ guesses, and for the relegation of the science to
less intellectual races than Greeks and other Europeans. Nobody seemed
to dare to depart from this fetish of uniform angular motion and
circular orbits until the insight, boldness, and independence of Johann
...
possible variation of the elements and finding them fail. The number of
hypotheses which he examined and rejected was almost incredible (for
example, that the planets turn round centres at a little distance from
the sun, that the epicycles have centres at a little distance from the
deferent, and so on). He says that, after using all these devices to
make theory agree with Tycho’s observations, he still found errors
amounting to eight minutes of a degree. Then he said boldly that it was
impossible that so good an observer as Tycho could have made a mistake
of eight minutes, and added: “Out of these eight minutes we will
construct a new theory that will explain the motions of all the
planets.” And he did it, with elliptic orbits having the sun in a focus
of each.[2]
...
placed all of the planetary orbits concentric with one another, the sun
being placed a little away from their common centre, and having no
apparent relation to them, and being actually outside the planes in
which they move. Kepler’s first great discovery was that the planes of
all the orbits pass through the sun; his second was that the line of
apses of each planet passes through the sun; both were contradictory to
...
His first law states that the planets describe ellipses with the sun at
a focus of each ellipse.
...
These two laws were published in his great work, _Astronomia Nova, sen.
Physica Coelestis tradita commentariis de Motibus Stelloe; Martis_,
Prague, 1609.

It took him nine years more[3] to discover his third law, that the
squares of the periodic times are proportional to the cubes of the mean
distances from the sun.

These three laws contain implicitly the law of universal gravitation.
They are simply an alternative way of expressing that law in dealing
with planets, not particles. Only, the power of the greatest human
intellect is so utterly feeble that the meaning of the words in
Kepler’s three laws could not be understood until expounded by the
logic of Newton’s dynamics.

The joy with which Kepler contemplated the final demonstration of these
laws, the evolution of which had occupied twenty years, can hardly be
imagined by us. He has given some idea of it in a passage in his work
on _Harmonics_, which is not now quoted, only lest someone might say it
was egotistical—a term which is simply grotesque when applied to such a
man with such a life’s work accomplished.

The whole book, _Astronomia Nova_, is a pleasure to read; the mass of
observations that are used, and the ingenuity of the propositions,
contrast strongly with the loose and imperfectly supported explanations
of all his predecessors; and the indulgent reader will excuse the
devotion of a few lines to an example of the ingenuity and beauty of
his methods.
...
observations giving only the relative direction from night to night.
Now, Kepler had twenty years of observations of Mars to deal with. This
enabled him to use a new method, to find the earth’s orbit. Observe the
date at any time when Mars is in opposition. The earth’s position E at
that date gives the longitude of Mars M. His period is 687 days. Now
choose dates before and after the principal date at intervals of 687
days and its multiples. Mars is in each case in the same position. Now
for any date when Mars is at M and the earth at E3 the date of the year
gives the angle E3SM. And the observation of Tycho gives the direction
of Mars compared with the sun, SE3M. So all the angles of the triangle
SEM in any of these positions of E are known, and also the ratios of
SE1, SE2, SE3, SE4 to SM and to each other.
...
void space. He compared universal gravitation to magnetism, and speaks
of the work of Gilbert of Colchester. (Gilbert’s book, _De Mundo Nostro
Sublunari, Philosophia Nova_, Amstelodami, 1651, containing similar
views, was published forty-eight years after Gilbert’s death, and
forty-two years after Kepler’s book and reference. His book _De
Magnete_ was published in 1600.)

A few of Kepler’s views on gravitation, extracted from the Introduction
to his _Astronomia Nova_, may now be mentioned:—
...
miserable makeshifts to earn enough to keep his family from starvation;
and proceeded to Ratisbon in 1630 to represent his claims to the Diet.
He arrived worn out and debilitated; he failed in his appeal, and died
from fever, contracted under, and fed upon, disappointment and
exhaustion. Those were not the days when men could adopt as a
profession the “research of endowment.”
...
From the all too brief epitome here given of Kepler’s greatest book, it
must be obvious that he had at that time some inkling of the meaning of
his laws—universal gravitation. From that moment the idea of universal
gravitation was in the air, and hints and guesses were thrown out by
many; and in time the law of gravitation would doubtless have been
discovered, though probably not by the work of one man, even if Newton
had not lived. But, if Kepler had not lived, who else could have
discovered his laws?
...
scientific part of his work dealt with terrestrial dynamics; but one of
those fortunate chances which happen only to really great men put him
in the way of originating a new branch of astronomy.
...
received by Paul V., the Pope, at Rome, to whom he explained his
discoveries.
...
Copernican theory, whose birth was welcomed by the Church, had now been
taken up by certain anti-clerical agitators, and was opposed by the
cardinals as well as by the dignitaries of the Reformed Church.
Galileo—a good Catholic—got mixed up in these discussions, although on
excellent terms with the Pope and his entourage. At last it came about
that Galileo was summoned to appear at Rome, where he was charged with
holding and teaching heretical opinions about the movement of the
earth; and he then solemnly abjured these opinions. There has been much
exaggeration and misstatement about his trial and punishment, and for a
long time there was a great deal of bitterness shown on both sides. But
the general verdict of the present day seems to be that, although
Galileo himself was treated with consideration, the hostility of the
Church to the views of Copernicus placed it in opposition also to the
true Keplerian system, and this led to unprofitable controversies. From
the time of Galileo onwards, for some time, opponents of religion
included the theory of the Earth’s motion in their disputations, not so
much for the love, or knowledge, of astronomy, as for the pleasure of
putting the Church in the wrong. This created a great deal of
bitterness and intolerance on both sides. Among the sufferers was
Giordano Bruno, a learned speculative philosopher, who was condemned to
...
telescopic discoveries of Galileo and of those who followed him, spread
a spirit of inquiry and philosophic thought throughout Europe, and once
more did astronomy rise in estimation; and the irresistible logic of
its mathematical process of reasoning soon placed it in the position it
has ever since occupied as the foremost of the exact sciences.
...
functions of angles, were so much simplified that Laplace declared that
by this invention the life-work of an astronomer was doubled.

Jeremiah Horrocks (born 1619, died 1641) was an ardent admirer of Tycho
Brahe and Kepler, and was able to improve the Rudolphine tables so much
that he foretold a transit of Venus, in 1639, which these tables failed
to indicate, and was the only observer of it. His life was short, but
he accomplished a great deal, and rightly ascribed the lunar inequality
called _evection_ to variations in the value of the eccentricity and in
the direction of the line of apses, at the same time correctly
assigning _the disturbing force of the Sun_ as the cause. He discovered
the errors in Jupiter’s calculated place, due to what we now know as
the long inequality of Jupiter and Saturn, and measured with
considerable accuracy the acceleration at that date of Jupiter’s mean
...
Having developed and enunciated the true laws of motion, he was able to
show that Kepler’s second law (that equal areas are described by the
line from the planet to the sun in equal times) was only another way of
saying that the centripetal force on a planet is always directed to the
sun. Also that Kepler’s first law (elliptic orbits with the sun in one
focus) was only another way of saying that the force urging a planet to
the sun varies inversely as the square of the distance. Also (if these
two be granted) it follows that Kepler’s third law is only another way
of saying that the sun’s force on different planets (besides depending
as above on distance) is proportional to their masses.
...
particles of a sphere of uniform density (or one composed of concentric
spherical shells, each of uniform density) acts as if the whole mass
were collected at the centre, he was able to express the meaning of
Kepler’s laws in propositions which have been summarised as follows:—
...
as the square of the distance between them, and directly as the product
of the masses of the two particles_.[2]

But Newton did not commit himself to the law until he had answered that
question about the apple; and the above proposition now enabled him to
deal with the Moon and the apple. Gravity makes a stone fall 16.1 feet
in a second. The moon is 60 times farther from the earth’s centre than
the stone, so it ought to be drawn out of a straight course through
16.1 feet in a minute. Newton found the distance through which she is
actually drawn as a fraction of the earth’s diameter. But when he first
examined this matter he proceeded to use a wrong diameter for the
earth, and he found a serious discrepancy. This, for a time, seemed to
condemn his theory, and regretfully he laid that part of his work
aside. Fortunately, before Newton wrote the _Principia_ the French
astronomer Picard made a new and correct measure of an arc of the
meridian, from which he obtained an accurate value of the earth’s
diameter. Newton applied this value, and found, to his great joy, that
when the distance of the moon is 60 times the radius of the earth she
is attracted out of the straight course 16.1 feet per minute, and that
the force acting on a stone or an apple follows the same law as the
force acting upon the heavenly bodies.[3]
...
Newton’s method of calculating the precession of the equinoxes, already
referred to, is as beautiful as anything in the _Principia_. He had
already proved the regression of the nodes of a satellite moving in an
orbit inclined to the ecliptic. He now said that the nodes of a ring of
satellites revolving round the earth’s equator would consequently all
regress. And if joined into a solid ring its node would regress; and it
would do so, only more slowly, if encumbered by the spherical part of
the earth’s mass. Therefore the axis of the equatorial belt of the
earth must revolve round the pole of the ecliptic. Then he set to work
and found the amount due to the moon and that due to the sun, and so he
solved the mystery of 2,000 years.
...
physical problems; and there can be little doubt that, if he could have
been furnished with complete tidal observations from different parts of
the world, his extraordinary powers of analysis would have enabled him
to reach a satisfactory theory. He certainly opened up many mines full
of intellectual gems; and his successors have never ceased in their
explorations. This has led to improved mathematical methods, which,
combined with the greater accuracy of observation, have rendered
physical astronomy of to-day the most exact of the sciences.

Laplace only expressed the universal opinion of posterity when he said
that to the _Principia_ is assured “a pre-eminence above all the other
...
in repute, not only for his own discoveries, but for the part he played
in urging Newton to commit to writing, and present to the Royal
Society, the results of his investigations. But for his friendly
insistence it is possible that the _Principia_ would never have been
written; and but for his generosity in supplying the means the Royal
Society could not have published the book.
...
Sir Isaac Newton died in 1727, at the age of eighty-five. His body lay
in state in the Jerusalem Chamber, and was buried in Westminster Abbey.
...
called the instantaneous ellipse with variable elements. The method was
much developed by Lagrange.

But again it was Laplace who solved the problem of the inequalities of
Jupiter and Saturn by the theory of gravitation, reducing the errors of
the tables from 20’ down to 12”, thus abolishing the use of empirical
corrections to the planetary tables, and providing another glorious
triumph for the law of gravitation. As Laplace justly said: “These
inequalities appeared formerly to be inexplicable by the law of
...
orbits to the comets which he studied, so that they come from infinity,
sweep round the sun, and go off to infinity for ever, after having been
visible a few weeks or months. He collected all the reliable
observations of comets he could find, to the number of twenty-four, and
computed their parabolic orbits by the rules laid down by Newton. His
object was to find out if any of them really travelled in elongated
ellipses, practically undistinguishable, in the visible part of their
paths, from parabolæ, in which case they would be seen more than once.
He found two old comets whose orbits, in shape and position, resembled
the orbit of a comet observed by himself in 1682. Apian observed one in
1531; Kepler the other in 1607. The intervals between these appearances
is seventy-five or seventy-six years. He then examined and found old
records of similar appearance in 1456, 1380, and 1305. It is true, he
noticed, that the intervals varied by a year and a-half, and the
inclination of the orbit to the ecliptic diminished with successive
apparitions. But he knew from previous calculations that this might
easily be due to planetary perturbations. Finally, he arrived at the
conclusion that all of these comets were identical, travelling in an
ellipse so elongated that the part where the comet was seen seemed to
be part of a parabolic orbit. He then predicted its return at the end
of 1758 or beginning of 1759, when he should be dead; but, as he said,
“if it should return, according to our prediction, about the year 1758,
impartial posterity will not refuse to acknowledge that this was first
discovered by an Englishman.”[3] [_Synopsis Astronomiae Cometicae_,
1749.]
...
nineteen observations of Uranus’s position, from the time of Flamsteed,
in 1690, had been recorded.
...
130 years (the period of revolution of Uranus is eighty-four years). So
he deliberately rejected the old ones, expressing the opinion that the
discrepancies might depend upon “some foreign and unperceived cause
which may have been acting upon the planet.” In a few years the errors
even of these tables became intolerable. In 1835 the error of longitude
was 30”; in 1838, 50”; in 1841, 70”; and, by comparing the errors
derived from observations made before and after opposition, a serious
error of the distance (radius vector) became apparent.

In 1843 John Couch Adams came out Senior Wrangler at Cambridge, and was
free to undertake the research which as an undergraduate he had set
himself—to see whether the disturbances of Uranus could be explained by
assuming a certain orbit, and position in that orbit, of a hypothetical
planet even more distant than Uranus. Such an explanation had been
suggested, but until 1843 no one had the boldness to attack the
...
being actually due to the perturbations produced by the unknown planet.
...
called on him Airy was away from home, but at the end of October, 1845,
he called again, and left a paper with full particulars of his results,
which had, for the most part, reduced the discrepancies to about 1”. As
a matter of fact, it has since been found that the heliocentric place
of the new planet then given was correct within about 2°.

Airy wrote expressing his interest, and asked for particulars about the
radius vector. Adams did not then reply, as the answer to this question
could be seen to be satisfactory by looking at the data already
supplied. He was a most unassuming man, and would not push himself
forward. He may have felt, after all the work he had done, that Airy’s
very natural inquiry showed no proportionate desire to search for the
planet. Anyway, the matter lay in embryo for nine months.
...
calculation was one of the most brilliant in the records of astronomy.
In criticism it has been said that these were exhibitions of skill
rather than helps to a solution of the particular problem, and that, in
claiming to find the elements of the orbit within certain limits, he
was claiming what was, under the circumstances, impossible, as the
result proved.
...
plan of attack which must in time settle the point. His first work was
to observe, and make a catalogue, or chart, of all stars near Adams’s
position.

On August 31st, 1846, Le Verrier published the concluding part of his
labours.
...
reducing these, he found a star, observed on August 12th, which was not
in the same place on July 30th. This was the planet, and he had also
observed it on August 4th.
...
welcomed by those who have themselves been engaged in like researches.
But, since the publication of the _Principia_, in 1687, there is
probably no analytical success which has raised among astronomers such
a feeling of admiration and gratitude as when Adams and Le Verrier
showed the inequalities in Uranus’s motion to mean that an unknown
planet was in a certain place in the heavens, where it was found.
...
when very striking proofs of the universality of the law of gravitation
convinced the most sceptical, it must still be borne in mind that,
while gravitation is certainly the principal force governing the
motions of the heavenly bodies, there may yet be a resisting medium in
space, and there may be electric and magnetic forces to deal with.
There may, further, be cases where the effects of luminous radiative
repulsion become apparent, and also Crookes’ vacuum-effects described
as “radiant matter.” Nor is it quite certain that Laplace’s proofs of
the instantaneous propagation of gravity are final.

And in the future, as in the past, Tycho Brahe’s dictum must be
maintained, that all theory shall be preceded by accurate observations.
It is the pride of astronomers that their science stands above all
others in the accuracy of the facts observed, as well as in the rigid
logic of the mathematics used for interpreting these facts.
...
positions was set up at Alexandria, the then centre of civilisation. We
know almost nothing about the instruments used by Hipparchus in
preparing his star catalogues and his lunar and solar tables; but the
invention of the astrolabe is attributed to him.[1]

In more modern times Nuremberg became a centre of astronomical culture.
Waltherus, of that town, made really accurate observations of star
altitudes, and of the distances between stars; and in 1484 A.D. he used
a kind of clock. Tycho Brahe tried these, but discarded them as being
inaccurate.
...
In the hands of such a skilful man as Tycho Brahe, the old open sights,
even without clocks, served their purpose sufficiently well to enable
Kepler to discover the true theory of the solar system. But telescopic
sights and clocks were required for proving some of Newton’s theories
of planetary perturbations. Picard’s observations at Paris from 1667
onwards seem to embody the first use of the telescope as a pointer. He
was also the first to introduce the use of Huyghens’s clocks for
observing the right ascension of stars. Olaus Romer was born at
Copenhagen in 1644. In 1675, by careful study of the times of eclipses
of Jupiter’s satellites, he discovered that light took time to traverse
space. Its velocity is 186,000 miles per second. In 1681 he took up his
duties as astronomer at Copenhagen, and built the first transit circle
on a window-sill of his house. The iron axis was five feet long and one
and a-half inches thick, and the telescope was fixed near one end with
a counterpoise. The telescope-tube was a double cone, to prevent
flexure. Three horizontal and three vertical wires were used in the
focus. These were illuminated by a speculum, near the object-glass,
reflecting the light from a lantern placed over the axis, the upper
part of the telescope-tube being partly cut away to admit the light. A
divided circle, with pointer and reading microscope, was provided for
reading the declination. He realised the superiority of a circle with
graduations over a much larger quadrant. The collimation error was
found by reversing the instrument and using a terrestrial mark, the
azimuth error by star observations. The time was expressed in fractions
of a second. He also constructed a telescope with equatoreal mounting,
to follow a star by one axial motion. In 1728 his instruments and
...
radius. He conducted his measurements with great skill, and introduced
new methods to attain accuracy, using certain stars for determining the
errors of his instruments; and he always reduced his observations to a
form in which they could be readily used. He introduced new methods for
determining the position of the equinox and the right ascension of a
fundamental star. He produced a catalogue of 2,935 stars. He supplied
Sir Isaac Newton with results of observation required in his
theoretical calculations. He died in 1719.

Halley succeeded Flamsteed to find that the whole place had been gutted
by the latter’s executors. In 1721 he got a transit instrument, and in
1726 a mural quadrant by Graham. His successor in 1742, Bradley,
replaced this by a fine brass quadrant, eight feet radius, by Bird; and
Bradley’s zenith sector was purchased for the observatory. An
instrument like this, specially designed for zenith stars, is capable
of greater rigidity than a more universal instrument; and there is no
trouble with refraction in the zenith. For these reasons Bradley had
set up this instrument at Kew, to attempt the proof of the earth’s
motion by observing the annual parallax of stars. He certainly found an
annual variation of zenith distance, but not at the times of year
...
Bessel and published in 1818, at Königsberg, in his well-known standard
work, _Fundamenta Astronomiae_. In it are results showing the laws of
refraction, with tables of its amount, the maximum value of aberration,
and other constants.

Bradley was succeeded by Bliss, and he by Maskelyne (1765), who carried
on excellent work, and laid the foundations of the Nautical Almanac
(1767). Just before his death he induced the Government to replace
Bird’s quadrant by a fine new mural _circle_, six feet in diameter, by
Troughton, the divisions being read off by microscopes fixed on piers
opposite to the divided circle. In this instrument the micrometer
screw, with a divided circle for turning it, was applied for bringing
the micrometer wire actually in line with a division on the circle—a
plan which is still always adopted.
...
circumpolar stars. Standard stars were used for giving the clock error.
In 1816 a new transit instrument, by Troughton, was added, and from
this date the Greenwich star places have maintained the very highest
accuracy.
...
is not completed until it has been reduced to a useful form; and in the
case of the sun, moon, and planets these results were, in every case,
compared with the tables, and the tabular error printed.
...
observations of the moon. Whenever a meridian transit of the moon could
be observed this was done. But, even so, there are periods in the month
when the moon is too near the sun for a transit to be well observed.
Also weather interferes with many meridian observations. To render the
lunar observations more continuous, Airy employed Troughton’s
successor, James Simms, in conjunction with the engineers, Ransome and
May, to construct an altazimuth with three-foot circles, and a
five-foot telescope, in 1847. The result was that the number of lunar
observations was immediately increased threefold, many of them being in
a part of the moon’s orbit which had previously been bare of
observations. From that date the Greenwich lunar observations have been
a model and a standard for the whole world.

Airy also undertook to superintend the reduction of all Greenwich lunar
observations from 1750 to 1830. The value of this laborious work, which
was completed in 1848, cannot be over-estimated.
...
Airy, like Bradley, was impressed with the advantage of employing stars
in the zenith for determining the fundamental constants of astronomy.
He devised a _reflex zenith tube_, in which the zenith point was
determined by reflection from a surface of mercury. The design was so
simple, and seemed so perfect, that great expectations were
entertained. But unaccountable variations comparable with those of the
transit circle appeared, and the instrument was put out of use until
1903, when the present Astronomer Royal noticed that the irregularities
could be allowed for, being due to that remarkable variation in the
position of the earth’s axis included in circles of about six yards
diameter at the north and south poles, discovered at the end of the
nineteenth century. The instrument is now being used for investigating
these variations; and in the year 1907 as many as 1,545 observations of
stars were made with the reflex zenith tube.
...
level mercury surface at the bottom and a telescope at the top pointing
downwards, which the writer saw in 1871. The reflection of the
micrometer wires and of a star very near the zenith (but not quite in
the zenith) can be observed together. His mercury trough was a circular
plane surface with a shallow edge to retain the mercury. The surface
quickly came to rest after disturbance by street traffic.
...
equatoreals. From the point of view of instruments of precision, one of
the most important new features is the astrographic equatoreal, set up
in 1892 and used for the Greenwich section of the great astrographic
chart just completed. Photography has come to be of use, not only for
depicting the sun and moon, comets and nebulae, but also to obtain
accurate relative positions of neighbouring stars; to pick up objects
that are invisible in any telescope; and, most of all perhaps, in
fixing the positions of faint satellites. Thus Saturn’s distant
satellite, Phoebe, and the sixth and seventh satellites of Jupiter,
have been followed regularly in their courses at Greenwich ever since
their discovery with the thirty-inch reflector (erected in 1897); and
while doing so Mr. Melotte made, in 1908, the splendid discovery on
some of the photographic plates of an eighth satellite of Jupiter, at
an enormous distance from the planet. From observations in the early
part of 1908, over a limited arc of its orbit, before Jupiter
approached the sun, Mr. Cowell computed a retrograde orbit and
calculated the future positions of this satellite, which enabled Mr.
Melotte to find it again in the autumn—a great triumph both of
calculation and of photographic observation. This satellite has never
been seen, and has been photographed only at Greenwich, Heidelberg, and
...
the heliometer, which is not used at Greenwich. This serves the purpose
of a double image micrometer, and is made by dividing the object-glass
of a telescope along a diameter. Each half is mounted so as to slide a
distance of several inches each way on an arc whose centre is the
focus. The amount of the movement can be accurately read. Thus two
fields of view overlap, and the adjustment is made to bring an image of
one star over that of another star, and then to do the same by a
displacement in the opposite direction. The total movement of the
half-object glass is double the distance between the star images in the
focal plane. Such an instrument has long been established at Oxford,
and German astronomers have made great use of it. But in the hands of
Sir David Gill (late His Majesty’s Astronomer at the Cape of Good
Hope), and especially in his great researches on Solar and on Stellar
parallax, it has been recognised as an instrument of the very highest
accuracy, measuring the distance between stars correctly to less than a
tenth of a second of arc.

The superiority of the heliometer over all other devices (except
photography) for measuring small angles has been specially brought into
prominence by Sir David Gill’s researches on the distance of the
...
precise observation to be made. The Transit of Venus in 1874, in which
the present writer assisted, overthrew this delusion.

In 1877 Sir David Gill used Lord Crawford’s heliometer at the Island of
Ascension to measure the parallax of Mars in opposition, and found the
sun’s distance 93,080,000 miles. He considered that, while the
...
and Sappho, and secured the co-operation of four other heliometers. His
final result was 92,870,000 miles, the parallax being 8",802 (_Cape
Obs_., Vol. VI.).
...
position of the centre of gravity of the earth and moon to which the
position of the observer was referred. This led him to correct the mass
of the moon, and to fix its ratio to the earth’s mass = 0.012240.
...
traversed in a year, and so the radius of the orbit. This has been done
by comparing observation and experiment. The aberration of light is an
angle 20” 48, giving the ratio of the earth’s velocity to the velocity
of light. The velocity of light is 186,000 miles a second; whence the
distance to the sun is 92,780,000 miles. There seems, however, to be
some uncertainty about the true value of the aberration, any
determination of which is subject to irregularities due to the
“seasonal errors.” The velocity of light was experimentally found, in
1862, by Fizeau and Foucault, each using an independent method. These
methods have been developed, and new values found, by Cornu,
Michaelson, Newcomb, and the present writer.

Quite lately Halm, at the Cape of Good Hope, measured spectroscopically
the velocity of the earth to and from a star by observations taken six
months apart. Thence he obtained an accurate value of the sun’s
distance.[5]
...
FOOTNOTES:
 ...
 [3] See Dreyer’s article on these instruments in _Copernicus_, Vol. I.
 They were stolen by the Germans after the relief of the Embassies, in
 1900. The best description of these instruments is probably that
 contained in an interesting volume, which may be seen in the library
 of the R. A. S., entitled _Chinese Researches_, by Alexander Wyllie
 (Shanghai, 1897).
...
Antonio de Dominis (Grant, _Hist. Ph. Ast_.), have led some to suppose
that they invented the telescope. The writer considers that it is more
likely that these notes refer to a kind of _camera obscura_, in which a
lens throws an inverted image of a landscape on the wall.
...
In 1609 Galileo, being in Venice, heard of the invention, went home and
worked out the theory, and made a similar telescope. These telescopes
were all made with a convex object-glass and a concave eye-lens, and
this type is spoken of as the Galilean telescope. Its defects are that
it has no real focus where cross-wires can be placed, and that the
field of view is very small. Kepler suggested the convex eye-lens in
1611, and Scheiner claimed to have used one in 1617. But it was
Huyghens who really introduced them. In the seventeenth century
...
Aberdeen and Edinburgh, in 1663, in his _Optica Promota_, proposed a
reflecting speculum of parabolic form. But it was Newton, about 1666,
who first made a reflecting telescope; and he did it with the object of
...
difficulty in making flint-glass lenses of large size. The first actual
inventor and constructor of an achromatic telescope was Chester Moor
Hall, who was not in trade, and did not patent it. Towards the close of
the eighteenth century a Swiss named Guinand at last succeeded in
producing larger flint-glass discs free from striae. Frauenhofer, of
Munich, took him up in 1805, and soon produced, among others, Struve’s
Dorpat refractor of 9.9 inches diameter and 13.5 feet focal length, and
another, of 12 inches diameter and 18 feet focal length, for Lamont, of
Munich.

In the nineteenth century gigantic _reflectors_ have been made.
Lassel’s 2-foot reflector, made by himself, did much good work, and
discovered four new satellites. But Lord Rosse’s 6-foot reflector, 54
feet focal length, constructed in 1845, is still the largest ever made.
The imperfections of our atmosphere are against the use of such large
apertures, unless it be on high mountains. During the last half century
excellent specula have been made of silvered glass, and Dr. Common’s
5-foot speculum (removed, since his death, to Harvard) has done
excellent work. Then there are the 5-foot Yerkes reflector at Chicago,
and the 4-foot by Grubb at Melbourne.
...
29½-inch by Gautier, the Pulkowa 30-inch by Clark. Then there was the
sensation of Clark’s 36-inch for the Lick Observatory in California,
and finally his _tour de force_, the Yerkes 40-inch refractor, for
Chicago.
...
observing seats, and rising floors and different forms of mounting, the
siderostats and coelostats, and other convenient adjuncts, besides the
registering chronograph and numerous facilities for aiding observation.
On each of these a chapter might be written; but the most important
part of the whole outfit is the man behind the telescope, and it is
with him that a history is more especially concerned.


SPECTROSCOPE.

Since the invention of the telescope no discovery has given so great an
impetus to astronomical physics as the spectroscope; and in giving us
information about the systems of stars and their proper motions it
rivals the telescope.

Frauenhofer, at the beginning of the nineteenth century, while applying
Dollond’s discovery to make large achromatic telescopes, studied the
dispersion of light by a prism. Admitting the light of the sun through
a narrow slit in a window-shutter, an inverted image of the slit can be
thrown, by a lens of suitable focal length, on the wall opposite. If a
wedge or prism of glass be interposed, the image is deflected to one
side; but, as Newton had shown, the images formed by the different
colours of which white light is composed are deflected to different
extents—the violet most, the red least. The number of colours forming
images is so numerous as to form a continuous spectrum on the wall with
all the colours—red, orange, yellow, green, blue, indigo, and violet.
But Frauenhofer found with a narrow slit, well focussed by the lens,
that some colours were missing in the white light of the sun, and these
were shown by dark lines across the spectrum. These are the Frauenhofer
lines, some of which he named by the letters of the alphabet. The D
line is a very marked one in the yellow. These dark lines in the solar
spectrum had already been observed by Wollaston.[3]
...
co-existent periods, of which the eleven-year period was predominant in
...
announced a similar period in the number of “magnetic storms” affecting
all of the three magnetic elements—declination, dip, and intensity.
Australian and Canadian observations both showed the decennial period
in all three elements. Wolf, of Zurich, and Gauthier, of Geneva, each
...
proof for every new theory. But the last doubts have long vanished, and
a connection has been further traced between violent outbursts of solar
activity and simultaneous magnetic storms.
...
magnetism. Wolf also collected old observations tracing the periodicity
of sun-spots back to about 1700 A.D.

Spoerer deduced a law of dependence of the average latitude of
sun-spots on the phase of the sun-spot period.

All modern total solar eclipse observations seem to show that the shape
of the luminous corona surrounding the moon at the moment of totality
has a special distinct character during the time of a sun-spot maximum,
and another, totally different, during a sun-spot minimum.
...
Solar photography has deprived astronomers of the type of Carrington of
the delight in devoting a life’s work to collecting data. It has now
become part of the routine work of an observatory.

In 1845 Foucault and Fizeau took a daguerreotype photograph of the sun.
In 1850 Bond produced one of the moon of great beauty, Draper having
made some attempts at an even earlier date. But astronomical
...
stereoscopic vision, which is now known to be of supreme accuracy. In
1853 he combined pairs of photographs of the moon in the same phase,
but under different conditions regarding libration, showing the moon
from slightly different points of view. These in the stereoscope
exhibited all the relief resulting from binocular vision, and looked
like a solid globe. In 1860 he used successive photographs of the total
solar eclipse stereoscopically, to prove that the red prominences
belong to the sun, and not to the moon. In 1861 he similarly combined
two photographs of a sun-spot, the perspective effect showing the umbra
like a floor at the bottom of a hollow penumbra; and in one case the
faculæ were discovered to be sailing over a spot apparently at some
considerable height. These appearances may be partly due to a proper
motion; but, so far as it went, this was a beautiful confirmation of
Wilson’s discovery. Hewlett, however, in 1894, after thirty years of
work, showed that the spots are not always depressions, being very
...
deplored), introduced successfully a scheme of photography, which might
almost be called a solar cinematograph. He took photographs of the sun
at intervals of fifteen or thirty seconds, and then enlarged selected
portions of these two hundred times, giving a picture corresponding to
a solar disc of six metres diameter. In these enlarged pictures he was
able to trace the movements, and changes of shape and brightness, of
individual rice-grains. Some granules become larger or smaller. Some
seem to rise out of a mist, as it were, and to become clearer. Others
grow feebler. Some are split in two. Some are rotated through a right
angle in a minute or less, although each of the grains may be the size
of Great Britain. Generally they move together in groups of very
various velocities, up to forty kilometres a second. These movements
seem to have definite relation to any sun-spots in the neighbourhood.
From the results already obtained it seems certain that, if this method
of observation be continued, it cannot fail to supply facts of the
greatest importance.
...
example, the hydrogen line H(3)—we obtain two photographs, one showing
the appearance of the calcium floculi, and the other of the hydrogen
floculi, on the same part of the solar surface; and nothing is more
astonishing than to note the total want of resemblance in the forms
shown on the two. This mode of research promises to afford many new and
useful data.
...
produced by a rapid motion in the line of sight. It has been found that
both uprushes and downrushes occur, but there is no marked predominance
of either in a sun-spot. The velocity of motion thus indicated in the
line of sight sometimes appears to amount to 320 miles a second. But it
must be remembered that pressure of a gas has some effect in displacing
the spectral lines. So we must go on, collecting data, until a time
comes when the meaning of all the facts can be made clear.
...
streamers radiating or interlacing, have much detail that can hardly be
recorded in a sketch. By the aid of photography a number of records can
be taken during the progress of totality. From a study of these the
extent of the corona is demonstrated in one case to extend to at least
six diameters of the moon, though the eye has traced it farther. This
corona is still one of the wonders of astronomy, and leads to many
questions. What is its consistency, if it extends many million miles
from the sun’s surface? How is it that it opposed no resistance to the
motion of comets which have almost grazed the sun’s surface? Is this
the origin of the zodiacal light? The character of the corona in
photographic records has been shown to depend upon the phase of the
sun-spot period. During the sun-spot maximum the corona seems most
developed over the spot-zones—i.e., neither at the equator nor the
poles. The four great sheaves of light give it a square appearance, and
are made up of rays or plumes, delicate like the petals of a flower.
During a minimum the nebulous ring seems to be made of tufts of fine
hairs with aigrettes or radiations from both poles, and streamers from
the equator.
...
eclipse, in which all observers found that the red prominences showed a
bright line spectrum, indicating the presence of hydrogen and other
...
atmosphere should be greatly weakened, while a bright line would suffer
no diminution by the high dispersion. On October 20th Lockyer,[10]
having news of the eclipse, but not of Jansen’s observations the day
after, was able to see these lines. This was a splendid performance,
for it enabled the prominences to be observed, not only during
eclipses, but every day. Moreover, the next year Huggins was able, by
using a wide slit, to see the whole of a prominence and note its shape.
Prominences are classified, according to their form, into “flame” and
“cloud” prominences, the spectrum of the latter showing calcium,
hydrogen, and helium; that of the former including a number of metals.
...
theory evolved to explain all the phenomena of the storm-swept metallic
...
that the continuous spectrum is derived from the _photosphere_ or solar
gaseous material compressed almost to liquid consistency; (2) that the
_reversing layer_ surrounds it and gives rise to black lines in the
spectrum; that the _chromosphere_ surrounds this, is composed mainly of
hydrogen, and is the cause of the red prominences in eclipses; and that
the gaseous _corona_ surrounds all of these, and extends to vast
distances outside the sun’s visible surface.
...
few words must suffice. Mountain ranges like our Andes or Himalayas are
rare. Instead of that, we see an immense number of circular cavities,
with rugged edges and flat interior, often with a cone in the centre,
reminding one of instantaneous photographs of the splash of a drop of
water falling into a pool. Many of these are fifty or sixty miles
across, some more. They are generally spoken of as resembling craters
of volcanoes, active or extinct, on the earth. But some of those who
have most fully studied the shapes of craters deny altogether their
resemblance to the circular objects on the moon. These so-called
craters, in many parts, are seen to be closely grouped, especially in
the snow-white parts of the moon. But there are great smooth dark
spaces, like the clear black ice on a pond, more free from craters, to
which the equally inappropriate name of seas has been given. The most
conspicuous crater, _Tycho_, is near the south pole. At full moon there
are seen to radiate from Tycho numerous streaks of light, or “rays,”
cutting through all the mountain formations, and extending over fully
half the lunar disc, like the star-shaped cracks made on a sheet of ice
by a blow. Similar cracks radiate from other large craters. It must be
mentioned that these white rays are well seen only in full light of the
sun at full moon, just as the white snow in the crevasses of a glacier
is seen bright from a distance only when the sun is high, and
disappears at sunset. Then there are deep, narrow, crooked “rills”
which may have been water-courses; also “clefts” about half a mile
wide, and often hundreds of miles long, like deep cracks in the surface
going straight through mountain and valley.
...
No certain changes have ever been observed; but several suspicions have
been expressed, especially as to the small crater _Linné_, in the _Mare
Serenitatis_. It is now generally agreed that no certainty can be
expected from drawings, and that for real evidence we must await the
verdict of photography.

No trace of water or of an atmosphere has been found on the moon. It is
possible that the temperature is too low. In any case, no displacement
of a star by atmospheric refraction at occultation has been surely
...
generally these are not seen, and six broad bands of absorption appear.
One is the F. of hydrogen; another is the red-star line of Jupiter and
Saturn. Neptune is a very difficult object for the spectroscope.
...
_Asteroids_.—The discovery of these new planets has been described. At
the beginning of the last century it was an immense triumph to catch a
new one. Since photography was called into the service by Wolf, they
have been caught every year in shoals. It is like the difference
between sea fishing with the line and using a steam trawler. In the
1908 almanacs nearly seven hundred asteroids are included. The
computation of their perturbations and ephemerides by Euler’s and
Lagrange’s method of variable elements became so laborious that Encke
devised a special process for these, which can be applied to many other
disturbed orbits.[8]

When a photograph is taken of a region of the heavens including an
asteroid, the stars are photographed as points because the telescope is
made to follow their motion; but the asteroids, by their proper motion,
appear as short lines.
...
have been given—Hector, Patroclus, Achilles; the other has not yet been
named.
...
FOOTNOTES:
 ...
 [8] _Ast. Nach_., Nos. 791, 792, 814, translated by G. B. Airy. _Naut.
 Alm_., Appendix, 1856.
...
Ever since Halley discovered that the comet of 1682 was a member of the
solar system, these wonderful objects have had a new interest for
astronomers; and a comparison of orbits has often identified the return
of a comet, and led to the detection of an elliptic orbit where the
difference from a parabola was imperceptible in the small portion of
the orbit visible to us. A remarkable case in point was the comet of
1556, of whose identity with the comet of 1264 there could be little
doubt. Hind wanted to compute the orbit more exactly than Halley had
done. He knew that observations had been made, but they were lost.
Having expressed his desire for a search, all the observations of
Fabricius and of Heller, and also a map of the comet’s path among the
stars, were eventually unearthed in the most unlikely manner, after
being lost nearly three hundred years. Hind and others were certain
that this comet would return between 1844 and 1848, but it never
appeared.
...
[Illustration: COPY OF THE DRAWING MADE BY PAUL FABRICIUS.
To define the path of comet 1556. After being lost for 300 years, this
drawing was recovered by the prolonged efforts of Mr. Hind and
Professor Littrow in 1856.]
...
almost every time that a great discovery has been made in the theory of
light, heat, chemistry, or electricity.
...
distance; and six have an aphelion distance about ten per cent, greater
than Neptune’s mean distance. Other comets are similarly associated
...
deflected by Jupiter out of an orbit in which it was invisible from the
earth into an orbit with a period of 5½ years, enabling it to be seen.
In 1779 it again approached Jupiter closer than some of his satellites,
and was sent off in another orbit, never to be again recognised.
...
days, and another 33¼ years. He noticed that the advance of the date of
the shower between 902 and 1833, at the rate of one day in seventy
years, meant a progression of the node of the orbit. Adams undertook to
calculate what the amount would be on all the five suppositions that
had been made about the period. After a laborious work, he found that
none gave one day in seventy years except the 33¼-year period, which
did so exactly. H. A. Newton predicted a return of the shower on the
night of November 13th-14th, 1866. He is now dead; but many of us are
alive to recall the wonder and enthusiasm with which we saw this
prediction being fulfilled by the grandest display of meteors ever seen
by anyone now alive.

The _progression_ of the nodes proved the path of the meteor stream to
be retrograde. The _radiant_ had almost the exact longitude of the
point towards which the earth was moving. This proved that the meteor
cluster was at perihelion. The period being known, the eccentricity of
the orbit was obtainable, also the orbital velocity of the meteors in
perihelion; and, by comparing this with the earth’s velocity, the
latitude of the radiant enabled the inclination to be determined, while
the longitude of the earth that night was the longitude of the node. In
such a way Schiaparelli was able to find first the elements of the
orbit of the August meteor shower (Perseids), and to show its identity
with the orbit of Tuttle’s comet 1862.iii. Then, in January 1867, Le
Verrier gave the elements of the November meteor shower (Leonids); and
Peters, of Altona, identified these with Oppolzer’s elements for
Tempel’s comet 1866—Schiaparelli having independently attained both of
these results. Subsequently Weiss, of Vienna, identified the meteor
shower of April 20th (Lyrids) with comet 1861. Finally, that
indefatigable worker on meteors, A. S. Herschel, added to the number,
and in 1878 gave a list of seventy-six coincidences between cometary
and meteoric orbits.
...
visual observation. Thus has Wolf, of Heidelburg, found upon old plates
the position of comet 1905.v., as a star of the 15.5 magnitude, 783
days before the date of its discovery. From the point of view of the
importance of finding out the divergence of a cometary orbit from a
parabola, its period, and its aphelion distance, this increase of range
attains the very highest value.
...
FOOTNOTES:
 ...
 [1] In 1874, when the writer was crossing the Pacific Ocean in H.M.S.
 “Scout,” Coggia’s comet unexpectedly appeared, and (while Colonel
 Tupman got its positions with the sextant) he tried to use the prism
 out of a portable direct-vision spectroscope, without success until it
 was put in front of the object-glass of a binocular, when, to his
 great joy, the three band images were clearly seen.
 ...
 support, and later ones, especially those by Backlund (also of St.
 Petersburg), seem to discredit, the idea of a resisting medium.
...
extended the applications of stereoscopic vision to astronomy—a subject
which De la Rue took up in the early days of photography. He has made a
stereo-comparator of great beauty and convenience for comparing
stereoscopically two star photographs taken at different dates. Wolf of
Heidelberg has used this for many purposes. His investigations
depending on the solar motion in space are remarkable. He photographs
stars in a direction at right angles to the line of the sun’s motion.
He has taken photographs of the same region fourteen years apart, the
two positions of his camera being at the two ends of a base-line over
5,000,000,000 miles apart, or fifty-six astronomical units. On
examining these stereoscopically, some of the stars rise out of the
general plane of the stars, and seem to be much nearer. Many of the
stars are thus seen to be suspended in space at different distances
corresponding exactly to their real distances from our solar system,
except when their proper motion interferes. The effect is most
striking; the accuracy of measurement exceeds that of any other method
of measuring such displacements, and it seems that with a long interval
of time the advantage of the method increases.
...
to be likely to throw light on stellar evolution. It is this: There are
many instances where one star of the pair is comparatively faint, and
the two stars are contrasted in colour; and in every single case the
general colour of the faint companion is invariably to be classed with
colours more near to the blue end of the spectrum than that of the
principal star.
...
delicate test of parallax is provided, unaffected by major instrumental
errors.
...
Lacaille’s, in the Southern hemisphere, was complementary. Then Piazzi,
Lalande, Groombridge, and Bessel were followed by Argelander with his
324,000 stars, Rumker’s Paramatta catalogue of the southern hemisphere,
and the frequent catalogues of national observatories. Later the
Astronomische Gesellschaft started their great catalogue, the combined
work of many observatories. Other southern ones were Gould’s at Cordova
and Stone’s at the Cape.
...
Europe to see it, and employed a local photographer to strap his camera
to the observatory equatoreal, driven by clockwork, and adjusted on the
comet by the eye. The result with half-an-hour’s exposure was good, so
he tried three hours. The result was such a display of sharp star
images that he resolved on the Cape Photographic Durchmusterung, which
after fourteen years, with Kapteyn’s aid in reducing, was completed.
Meanwhile the brothers Henry, of Paris, were engaged in going over
Chacornac’s zodiacal stars, and were about to catalogue the Milky Way
portion, a serious labour, when they saw Gill’s Comet photograph and
conceived the idea of doing the rest of their work by photography. Gill
had previously written to Admiral Mouchez, of the Paris Observatory,
and explained to him his project for charting the heavens
photographically, by combining the work of many observatories. This led
Admiral Mouchez to support the brothers Henry in their scheme.[21]
Gill, having got his own photographic work underway, suggested an
international astrographic chart, the materials for different zones to
be supplied by observatories of all nations, each equipped with similar
photographic telescopes. At a conference in Paris, 1887, this was
decided on, the stars on the charts going down to the fourteenth
magnitude, and the catalogues to the eleventh.

[Illustration: GREAT COMET, NOV. 14TH, 1882.
(Exposure 2hrs. 20m.) By kind permission of Sir David Gill. From this
photograph originated all stellar chart-photography.]
...
giant telescopes he opened in this direction a new branch of astronomy.
At one time he held that all nebulæ might be clusters of innumerable
minute stars at a great distance. Then he recognised the different
classes of nebulæ, and became convinced that there is a widely-diffused
“shining fluid” in space, though many so-called nebulæ could be
resolved by large telescopes into stars. He considered that the Milky
Way is a great star cluster, whose form may be conjectured from
numerous star-gaugings. He supposed that the compact “planetary nebulæ”
might show a stage of evolution from the diffuse nebulæ, and that his
classifications actually indicate various stages of development. Such
speculations, like those of the ancients about the solar system, are
apt to be harmful to true progress of knowledge unless in the hands of
the ablest mathematical physicists; and Herschel violated their
principles in other directions. But here his speculations have
attracted a great deal of attention, and, with modifications, are
accepted, at least as a working hypothesis, by a fair number of people.
...
Huggins found that all true nebulae give a spectrum of bright lines.
Three are due to hydrogen; two (discovered by Copeland) are helium
lines; others are unknown. Fifty-five lines have been photographed in
the spectrum of the Orion nebula. It seems to be pretty certain that
all true nebulae are gaseous, and show almost exactly the same
spectrum.
...
A great deal has to be done by the chemist before the astronomer can be
on sure ground in drawing conclusions from certain portions of his
...
an interesting light on the evolution of a modern train of thought that
seems to delight in conjecture, while rebelling against that strict
mathematical logic which has crowned astronomy as the queen of the
sciences.
...
FOOTNOTES:
 ...
 earth’s mean distance at 93,000,000 miles, 1
 light-year=5,865,696,000,000 miles or 63,072 astronomical units; 1
 astronomical unit a year=2.94 miles a second; and the earth’s orbital
 velocity=18.5 miles a second.
...
Obverse and reverse sides, containing record of solar eclipse, 1062
B.C., used lately by Cowell for rendering the lunar theory more
accurate than was possible by finest modern observations. (British
Museum collection, No. 35908.)
 ...
 By F. Wanderer, from Reitlinger’s “Johannes Kepler” (Original in
 Strassburg).
...
with umbræ, penumbræ, and faculæ.
 ...
 SOLAR ECLIPSE, 1882.
From drawing by W. H. Wesley, Secretary R.A.S.; showing the
prominences, the corona, and an unknown comet.

 JUPITER.
From a drawing by E. M. Antoniadi, showing transit of a satellite’s
shadow, the belts, and the “great red spot” (_Monthly Notices_, R. A.
S., vol. lix., pl. x.).
...
By kind permission of Sir David Gill. From this photograph originated
all stellar chart-photography.
...
Tupman, G. L., 120
Tuttle, 125
Tycho Brahe, 23, 25, 30, 33-38, 39, 40, 44, 50, 75, 77, 93, 94, 129,
137
